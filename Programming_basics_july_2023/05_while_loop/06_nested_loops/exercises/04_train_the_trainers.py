...
while input_line != 'Finish':
    ...
    for i in range(1, people_assessnent + 1):
        current_grade = float(input())
        count_all_grades += 1
        sum_all_grades += current_grade
        sum_current_grades = sum_current_grades + current_grade

    average_current_grade = sum_current_grades / people_assessnent
